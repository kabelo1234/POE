...
public class LoginTest {
    ...
    public void testUsernameCorrectlyFormatted() {
        ...
        assertEquals(expected, user.registerUser("John", "Ch&sec@ke99!", "+27838968976", "kyl_1", "Doe"));
    }
    ...
    public void testUsernameIncorrectlyFormatted() {
        ...
        assertEquals(expected, user.registerUser("John", "Ch&sec@ke99!", "+27838968976", "kyle!!!!!!!", "Doe"));
    }
    ...
    public void testPasswordDoesNotMeetComplexity() {
        ...
        assertEquals(expected, user.registerUser("John", "password", "+27838968976", "kyl_1", "Doe"));
    }
    ...
    public void testCellNumberIncorrectlyFormatted() {
        ...
        assertEquals(expected, user.registerUser("John", "Ch&sec@ke99!", "08966553", "kyl_1", "Doe"));
    }
    ...
    public void testLoginSuccessful() {
        ...
        assertTrue(result);
        assertEquals("Welcome John Doe it is great to see you again.", user.returnLoginStatus(result));
    }
